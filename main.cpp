...
int main(void)
{
    ...
    float scale = 6.0f;//tamaño personaje
    float personajeVel = 4.0f;//velocidad del personaje en movimiento
    float mesaScale1 = 0.2f;//tamaño de la mesa
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        if (framesCounter >= (60 / framesSpeed)) {
            ...
            if (currentFrame > 5) currentFrame = 0; //hay 6 cuadros de animacion
